...
function ProjectCard({ project }) {
  ...
  console.log(project);
  return (
    <div className="w-full shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow duration-300 md:w-[48%] bg-gray-800 border-[1px] border-gray-700">
      ...
      <h1 className="text-md text-white  font-semibold">How it Helps</h1>
      <p className="text-gray-400 mb-6">{howItHelps}</p>
      <h1 className="text-md text-white mb-3 font-semibold">Features</h1>
      <ul>
